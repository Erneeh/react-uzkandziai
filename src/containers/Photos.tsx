  ...
  return (
    <div className="overflow-hidden bg-headerColor py-10 sm:py-16">
      <div className=" mx-auto justify-center items-center flex flex-col  text-headerFooterText w-screen text-center font-poppins'">
        ...
        <div className="mx-auto grid w-screen px-6 md:px-16 grid-cols-2 gap-x-3 gap-y-3 md:gap-y-6 md:gap-x-6 sm:gap-y-10 lg:mx-0 lg:max-w-none lg:grid-cols-3 pt-6">
          <PhotoDiv></PhotoDiv>
        </div>
    </div>
  </div>
